...
const Payments = () => {
  ...
  const earliestSelectableMonth = useMemo(() => {
    const minMonth =
      earliestPaymentMonth != null ? earliestPaymentMonth : getCurrentYearMonth(0);
    return combineMinYearMonth(minMonth);
            ...
            <FlatList
              ...
              ListEmptyComponent={
                <View style={styles.emptyContainer}>
                  ...
                  <Text style={styles.emptyText}>
                    {language === "en"
                      ? `No payment records available for ${getMonthLabel(selectedMonth, language)}.`
                      : `${getMonthLabel(selectedMonth, language)} साठी पेमेंट नोंदी उपलब्ध नाहीत.`}
                  </Text>
                </View>
              }
              showsVerticalScrollIndicator={false}
