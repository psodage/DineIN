...
export function displayStatusMr(language, statusEn, statusMr) {
...
export function displayMealPlanMr(language, mealPlanEn, mealPlanMr) {
...
export function formatPollOptionLabel(option, language) {
